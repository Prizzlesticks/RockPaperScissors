...
public class RockPaperScissorsApp {
	...
	//output choices for player and R/P/S, gather player choices in 2 loops for validation
	...
	if (opp == 1) {
		Player1 player = new Player1();
		//player.value(); 
		oppChoice = player.value();
		//oppChoice = oppChoice1;
	...
	//System.out.println("You chose rpschoice" + " that does/doesnt beat" + " compchoice." + " You've: " + "won/lost" );
	games++;
	if (win == 1) {
		wins++;
